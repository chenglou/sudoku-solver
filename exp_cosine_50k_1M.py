# Experiment: Scale up to ~1M params
# Based on exp_cosine_50k.py (82.8% at 800K params)
# Changes:
#   - d_model=144 (from 128)
#   - d_ff=576 (from 512, keeping 4x ratio)
#   - ~1M params total
# Hypothesis: More capacity might help, especially with larger batch
...
CHECKPOINT_PREFIX = "cosine_50k_1M_checkpoint_step"

CONFIG = {
    'experiment': 'exp_cosine_50k_1M',
    'd_model': 144,
    'd_ff': 576,
    'n_layers': 4,
    'batch_size': 4096,
...
d_model = 144  # Scaled up from 128
n_heads = 4    # 144/4 = 36 per head
d_ff = 576     # Scaled up from 512 (4x d_model)
n_layers = 4
n_iterations = 16
lr = 1.5e-3
warmup_steps = 1400
...
def train(output_dir="."):
    ...
    print(f"\nExperiment: 1M params (d_model=144, d_ff=576)")
    ...
    log_path = os.path.join(output_dir, "exp_cosine_50k_1M.log")
    ...
    log(f"800K baseline: 82.8%")

    final_path = os.path.join(output_dir, "model_cosine_50k_1M.pt")
