# RRN ABLATION: No structured positional encoding
# Uses simple learned 81-position embedding instead of row/col/box
# Keeps: intermediate supervision
...
class SudokuRRN(nn.Module):
    def __init__(self, edge_index):
        ...
        # ABLATION: Simple learned 81-position embedding instead of row/col/box
    ...
    def forward(self, x, return_all=False):
        ...
        device = x.device
        # ABLATION: Simple positional embedding
...
print(f"\nRRN ABLATION: No structured pos encoding (simple learned 81-pos)")
print(f"Training on {device}...")

log_file = open("rrn_ablation_no_sudoku_pos.log", "w")
