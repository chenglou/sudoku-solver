# Baseline architecture with LR=2e-3 (vs baseline LR=1.5e-3).
# Purpose: test if higher LR causes earlier iteration collapse.
...
CHECKPOINT_PREFIX = "baseline_lr2e3_checkpoint_step"
...
log_name = "exp_baseline_lr2e3.log"
...
def train(output_dir="."):
    ...
    log("\n" + "="*60)
    log("FINAL RESULTS - exp_baseline_lr2e3")
    log("="*60)
    results = evaluate_all()
    total_r = results.pop('_total')
    ...
    final_path = os.path.join(output_dir, "model_baseline_lr2e3.pt")
