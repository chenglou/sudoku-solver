# BS=1024, 16 iters, reverse curriculum.
# Purpose: test if even smaller batch size → even more stable iterations.
# Control: exp_bs2048_baseline (same but BS=2048 → 81.4%, 98.1% at 1024 iters).
...
CHECKPOINT_PREFIX = "bs1024_curriculum_checkpoint_step"

CONFIG = {
    'experiment': 'exp_bs1024_curriculum',
    'd_model': 128,
    'd_ff': 512,
    'n_layers': 4,
    'batch_size': 1024,
...
log_name = "exp_bs1024_curriculum.log"
...
def train(output_dir="."):
    ...
    print(f"\nExperiment: BS=1024 with reverse curriculum")
    ...
    log("\n" + "="*60)
    log("FINAL RESULTS - exp_bs1024_curriculum")
    log("="*60)
    results = evaluate_all()
    total_r = results.pop('_total')
    ...
    final_path = os.path.join(output_dir, "model_bs1024_curriculum.pt")
