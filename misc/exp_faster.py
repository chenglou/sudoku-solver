# Experiment: Faster head_dim for throughput
# Based on exp_cosine_50k_1M.py but uses d_model=128 (head_dim=32).
# Goal: improve kernel efficiency while keeping training setup similar.
...
CHECKPOINT_PREFIX = "faster_checkpoint_step"

CONFIG = {
    'experiment': 'exp_faster',
    'd_model': 128,
    'd_ff': 512,
    'n_layers': 4,
    'batch_size': 4096,
...
def train(output_dir="."):
    ...
    final_path = os.path.join(output_dir, "model_faster.pt")
