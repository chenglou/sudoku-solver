# ABLATION: No sudoku positional encoding - use learned 81-position embeddings
# Keep: iterative refinement (16 iter), intermediate supervision
import torch
...
class SudokuTransformer(nn.Module):
    def __init__(self):
        ...
        # ABLATION: Use simple learned 81-position embedding instead of row/col/box
    ...
    def forward(self, x, return_all=False):
        ...
        for _ in range(n_iterations):
            ...
            h = h + self.pos_embed  # ABLATION: simple learned positional embedding
...
print(f"\nABLATION: No sudoku positional encoding (simple learned 81-pos)")
print(f"Training on {device}...")

log_file = open("ablation_no_sudoku_pos.log", "w")
def log(msg):
    print(msg)
    log_file.write(msg + "\n")
    log_file.flush()
...
for step in range(steps):
    ...
    # Intermediate supervision (keep this)
    loss = 0
