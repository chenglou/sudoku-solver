...
# With intermediate supervision and structured positional encoding for fair comparison
...
# Hyperparameters
hidden_size = 128  # Matched to transformer
num_steps = 16
lr = 1e-3
steps = 100000
n_train = 100000
...
# Precompute row/col/box indices for structured positional encoding
...
class SudokuRRN(nn.Module):
    def __init__(self, edge_index):
        ...
        # Structured positional embeddings: row, col, box (like transformer)
    ...
    def forward(self, x, return_all=False):
        ...
        # Structured positional embedding
        ...
        x_embed = self.input_proj(x) + pos_embed
...
print(f"\nRRN with: intermediate supervision, structured pos encoding, Muon optimizer")
